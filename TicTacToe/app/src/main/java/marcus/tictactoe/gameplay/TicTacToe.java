...
public class TicTacToe{
    ...
    protected void checkBoard(){
        if (checkBoardDirections(board)){
            ...
            //Toast toast = Toast.makeText(this.context, "Player " + player + " has won!", Toast.LENGTH_LONG);
            //toast.show();
            setScore(1);
            resetBoard();
        } else if (checkFullBoard()){
            showOverlay("Tie Game");
            //Toast toast = Toast.makeText(this.context, "Tie!", Toast.LENGTH_LONG);
            //toast.show();
            setScore(2);
            resetBoard();
        }
     ...
     * to go back to main menu. Currently not working.
     */
